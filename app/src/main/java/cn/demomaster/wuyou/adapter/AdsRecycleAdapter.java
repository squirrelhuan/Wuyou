...
public class AdsRecycleAdapter extends RecyclerView.Adapter<AdsRecycleAdapter.ViewHolder> {
    ...
    private List<AdsModel> lists = null;
    private Context context;
    QDTipPopup qdTipPopup;
    private OnItemClickListener onItemClickListener;

    public AdsRecycleAdapter(Context context, List<AdsModel> logBeans) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.layout_ads_item, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        AdsModel appInfo = lists.get(position);
...
//        int id = getResId(appInfo.getName(), R.mipmap.class);
    ...
    public void updateList( List<AdsModel> data) {
        this.lists = data;
